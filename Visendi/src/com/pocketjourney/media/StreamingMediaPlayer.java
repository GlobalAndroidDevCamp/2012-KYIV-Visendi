...
public class StreamingMediaPlayer {
	...
	/*
	 * // Track for display by progressBar private long mediaLengthInKb,
	 * mediaLengthInSeconds; private int totalKbRead = 0;
	 */
	...
	public StreamingMediaPlayer(Context context, TextView textStreamed,
			ImageButton playButton, String title) {
		this.context = context;
		this.textStreamed = textStreamed;
		this.playButton = playButton;
		this.textTitle = title;
		this.textStreamed.setText(this.textTitle);
	}
